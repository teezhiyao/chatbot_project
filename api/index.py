...
@app.get("/api/policyInfo", response_model=schemas.PolicyInfo)
def read_policy_info(policy_info: schemas.PolicyInfo, db: Session = Depends(get_db)):
...
@app.put("/api/policy", response_model=schemas.PolicyInstance)
...
@app.delete("/api/policy", response_model=schemas.PolicyInstance)
...
@app.get("/api/user", response_model=schemas.PolicyHolder)
